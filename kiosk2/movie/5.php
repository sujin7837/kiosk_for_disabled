...
<html>
  ...
  <body id="main">
    ...
    <div class="nameBottom"></div>
    <div id="view1">
                <?php echo '<div id="image"><img src="media/'.$_POST['movie_name_post'].'.png"></div>'; ?>
                <div id="view2">
                    <?php
                      echo '
                      <div id="movietitle" style="float:left; padding-left:70px;"> <img src="img/'.$_POST['age_post'].'.png" id="grade"> <b id="movie_name">'.$_POST['movie_name_post'].'</b></div>
                    </div>
                <div id="zero"></div>
                <div id="view3">
    ...
    <img name="slide2" class="movieAd"></img>
...
<!-- 거의 다 바뀜 1002 -->
    ...
    <script src="js/changeMovieAd.js"></script>
