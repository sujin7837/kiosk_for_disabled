...
function selectHere() { // 매장 식사 누를 시
    ...
    var hereC = document.getElementById("hereC");
    hereC.style.display = ""
    var togo = document.getElementById("togo");
    togo.style.display = ""
    var togoC = document.getElementById("togoC");
    togoC.style.display = "none"
}
...
function selectCard() { // 카드결제 누를 시
    ...
    var mobileC = document.getElementById("mobileC");
